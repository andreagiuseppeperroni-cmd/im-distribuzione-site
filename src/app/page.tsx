  ...
  return (
    <main className="max-w-5xl mx-auto px-8 py-12 text-gray-800">
      <section className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-6">I.M. DISTRIBUZIONE</h1>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-2 gap--4">
          className="border-2 border-blue-600 text-blue-600 px-4 py-2 rounded hover:bg-blue-600 hover:text-white">Richiedi Preventivo</a>
        </div>
      </section>
